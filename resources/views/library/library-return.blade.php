...
<div class="card-body">
   <h5>   Books Return Page</h5>
</div>
<form action="javascript:void(0)"  id="bookReturnForm" name="bookReturnForm" >
...
<div style="display: none;" class="pop-outer">
    <div class="pop-inner">
        <h2 class="pop-heading">Book Return Successfully</h2>
    </div>
</div> 
@endsection
@section('scripts')
